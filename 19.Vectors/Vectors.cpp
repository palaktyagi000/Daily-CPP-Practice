...
int main(){
    ...
    //Understand at memory level, what are the differences int the two
    cout<<v.size()<<endl;
    cout<<v.capacity()<<endl;//size of underlying array
    cout<<v.max_size()<<endl;//maximum no of elements a vector can hold in the worst cse acc to avbl memory in the system
